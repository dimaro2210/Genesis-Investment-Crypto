    ...
    <footer className="border-t border-border bg-background/50 backdrop-blur-sm">
      <div className="container py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">CryptoMate</h3>
            <p className="text-muted-foreground text-sm">
              A modern cryptocurrency trading platform with powerful tools and analytics.
            </p>
          </div>
        ...
        <div className="border-t border-border mt-8 pt-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} CryptoMate. All rights reserved.
          </p>
